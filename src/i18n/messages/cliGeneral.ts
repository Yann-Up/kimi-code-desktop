...
export default {
  zh: {
    ...
    'cliGeneral.perm.manual': '始终询问',
    'cliGeneral.perm.yolo': '必要时询问',
    'cliGeneral.perm.auto': '完全自动',
    ...
    'cliGeneral.defaultPermissionModeDesc':
      '新会话的工具调用审批策略(0.41 起更名,括号内为旧名):manual=始终询问(原 Manual)、yolo=必要时询问(原 YOLO,常规操作自动放行、高风险动作仍询问)、auto=完全自动(原 Auto)',
  ...
  en: {
    ...
    'cliGeneral.perm.manual': 'Always Ask',
    'cliGeneral.perm.yolo': 'Ask When Needed',
    'cliGeneral.perm.auto': 'Never Ask',
    ...
    'cliGeneral.defaultPermissionModeDesc':
      'Tool-call approval policy for new sessions (renamed in 0.41, old names in parentheses): manual=Always Ask (formerly Manual), yolo=Ask When Needed (formerly YOLO; routine actions run automatically, risky ones still ask), auto=Never Ask (formerly Auto)',
